...
Public Class MDIMain
    ...
    Dim Cls_Rug_Utility As New AgUtility.ClsMain(AgL)
    ...
    Public Sub FMenuItem_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Select Case Trim(UCase(StrCurrentModule))
            ...
            Case Trim(UCase(AgUtility.ClsMain.ModuleName))
                If StrType.Trim = "" Then
    ...
    Private Sub FManageMDI()
        ...
        Dim RugUtilityMdi As New AgUtility.MDIMain
        RugUtilityMdi.Visible = True
        FGenerate_UP(RugUtilityMdi, AgUtility.ClsMain.ModuleName, 0, AgUtility.ClsMain.ModuleName, GCnCmd)
    ...
    Private Sub FManageUserControl()
        ...
        ClsMF.FGenerate_UP_Control(Cls_Rug_Utility, AgUtility.ClsMain.ModuleName, GCnCmd)
