Public Class FrmMenuItem
    ...
    Public Const Col1BomItem As String = "Bom Item"
    Public Const Col1Qty As String = "Qty"
    Public WithEvents Label6 As System.Windows.Forms.Label
    Public WithEvents TxtOutlet As AgControls.AgTextBox
...
#Region "Designer Code"
    Private Sub InitializeComponent()
        ...
        Me.TxtOutlet = New AgControls.AgTextBox
        ...
        Me.LblUnit.Location = New System.Drawing.Point(212, 121)
        ...
        Me.TxtRate.Location = New System.Drawing.Point(521, 140)
        Me.TxtRate.MaxLength = 20
        Me.TxtRate.Name = "TxtRate"
        Me.TxtRate.Size = New System.Drawing.Size(172, 18)
        ...
        Me.Label3.Location = New System.Drawing.Point(427, 140)
        ...
        Me.Label6.Location = New System.Drawing.Point(292, 147)
        ...
        'TxtOutlet
        '
        Me.TxtOutlet.AgAllowUserToEnableMasterHelp = False
        Me.TxtOutlet.AgMandatory = True
        Me.TxtOutlet.AgMasterHelp = False
        Me.TxtOutlet.AgNumberLeftPlaces = 0
        Me.TxtOutlet.AgNumberNegetiveAllow = False
        Me.TxtOutlet.AgNumberRightPlaces = 0
        Me.TxtOutlet.AgPickFromLastValue = False
        Me.TxtOutlet.AgRowFilter = ""
        Me.TxtOutlet.AgSearchMethod = AgControls.AgLib.TxtSearchMethod.Simple
        Me.TxtOutlet.AgSelectedValue = Nothing
        Me.TxtOutlet.AgTxtCase = AgControls.AgTextBox.TxtCase.None
        Me.TxtOutlet.AgValueType = AgControls.AgTextBox.TxtValueType.Text_Value
        Me.TxtOutlet.BorderStyle = System.Windows.Forms.BorderStyle.None
        Me.TxtOutlet.Font = New System.Drawing.Font("Arial", 11.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.TxtOutlet.Location = New System.Drawing.Point(308, 140)
        Me.TxtOutlet.MaxLength = 20
        Me.TxtOutlet.Name = "TxtOutlet"
        Me.TxtOutlet.Size = New System.Drawing.Size(112, 18)
        Me.TxtOutlet.TabIndex = 4
        '
        'Label7
        '
        Me.Label7.AutoSize = True
        Me.Label7.Font = New System.Drawing.Font("Arial", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.Label7.Location = New System.Drawing.Point(212, 142)
        ...
        Me.Controls.SetChildIndex(Me.TxtOutlet, 0)
...
#End Region
    ...
    Private Sub FrmYarn_BaseEvent_Data_Validation(ByRef passed As Boolean) Handles Me.BaseEvent_Data_Validation
        ...
        If AgCL.AgIsDuplicate(Dgl1, "" & Col1BomItem & "") Then passed = False : Exit Sub
    End Sub
    ...
    Public Overridable Sub FrmYarn_BaseEvent_FindLog() Handles Me.BaseEvent_FindLog
        ...
        AgL.PubFindQry = "SELECT I.UID, I.ManualCode as [Item_Code], I.Description [Item_Description], I.Unit, I.Rate, G.Description as Item_Group, C.Description as Item_Category " & _
                        ...
                        " Left Join ItemCategory C On G.ItemCategory = C.Code " & mConStr & _
                        " And I.ItemType = '" & ClsMain.ItemType.FinishMaterial & "' " & _
    ...
    Public Overridable Sub FrmYarn_BaseEvent_FindMain() Handles Me.BaseEvent_FindMain
        ...
        AgL.PubFindQry = "SELECT I.Code, I.ManualCode as [Item_Code], I.Description [Item_Description], I.Unit, I.Rate, G.Description as Item_Group, C.Description as Item_Category " & _
                        ...
                        " Left Join ItemGroup G On I.ItemGroup = G.Code " & _
                        " Left Join ItemCategory C On G.ItemCategory = C.Code " & mConStr & _
                        " And I.ItemType = '" & ClsMain.ItemType.FinishMaterial & "'   "
        AgL.PubFindQryOrdBy = "[Item Description]"
    End Sub
    ...
    Private Sub FrmYarn_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As System.Data.SqlClient.SqlConnection, ByVal Cmd As System.Data.SqlClient.SqlCommand) Handles Me.BaseEvent_Save_InTrans
        mQry = "UPDATE Item_Log " & _
                ...
                " Outlet = " & AgL.Chk_Text(TxtOutlet.AgSelectedValue) & ", " & _
                " Unit = " & AgL.Chk_Text(TxtUnit.Text) & ", " & _
                " ItemGroup = " & AgL.Chk_Text(TxtItemGroup.AgSelectedValue) & ", " & _
                " ItemType = " & AgL.Chk_Text(ClsMain.ItemType.FinishMaterial) & ", " & _
                " Rate = " & Val(TxtRate.Text) & " " & _
                " Where UID = '" & SearchCode & "' "
        AgL.Dman_ExecuteNonQry(mQry, AgL.GCn, AgL.ECmd)

        mQry = "Delete From BomDetail_Log Where UID = '" & SearchCode & "'"
        AgL.Dman_ExecuteNonQry(mQry, AgL.GCn, AgL.ECmd)

        Dim I As Integer
        With Dgl1
            For I = 0 To .RowCount - 1
                If .Item(Col1BomItem, I).Value <> "" Then
                    mQry = "INSERT INTO BomDetail_Log (UID, Code, Sr, Item, Qty) " & _
                           "VALUES (" & AgL.Chk_Text(SearchCode) & ", " & AgL.Chk_Text(mInternalCode) & ", " & _
                           " " & Val(I) & ", " & AgL.Chk_Text(.AgSelectedValue(Col1BomItem, I)) & ", " & _
    ...
    Private Sub FrmQuality1_BaseFunction_FIniList() Handles Me.BaseFunction_FIniList
        ...
        mQry = "Select H.Code, H.Description as Item_Group, C.Description as Item_Category " & _
               ...
               " Where H.ItemType = '" & ClsMain.ItemType.FinishMaterial & "' " & _
        ...
        mQry = " Select I.Code, I.Description As Item From Item I Where I.ItemType = '" & ClsMain.ItemType.RawMaterial & "'"
        Dgl1.AgHelpDataSet(Col1BomItem) = AgL.FillData(mQry, AgL.GCn)

        mQry = " Select H.Code, H.Description As Outlet From Outlet H "
        TxtOutlet.AgHelpDataSet = AgL.FillData(mQry, AgL.GCn)
    End Sub

    Private Sub FrmQuality1_BaseFunction_IniGrid() Handles Me.BaseFunction_IniGrid
        With AgCL
            .AddAgTextColumn(Dgl1, ColSNo, 40, 5, ColSNo, True, True, False)
            .AddAgTextColumn(Dgl1, Col1BomItem, 240, 0, Col1BomItem, True, False, False)
            .AddAgNumberColumn(Dgl1, Col1Qty, 170, 5, 2, False, Col1Qty, True, False, False)
        End With
        AgL.GridDesign(Dgl1)
    ...
    Private Sub FrmQuality1_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        If FrmType = ClsMain.EntryPointType.Main Then
            mQry = "Select I.Code, I.ManualCode, I.Description, I.Unit, I.Rate, I.ItemGroup, I.Outlet, G.Description as ItemGroupDesc " & _
                " From Item I " & _
                " Left Join ItemGroup G On I.ItemGroup = G.Code  " & _
        ...
        With DsTemp.Tables(0)
            If .Rows.Count > 0 Then
                ...
                TxtOutlet.AgSelectedValue = AgL.XNull(.Rows(0)("Outlet"))
                ...
                Dim I As Integer
                If FrmType = ClsMain.EntryPointType.Main Then
                    mQry = "Select * from BomDetail where Code = '" & SearchCode & "'"
                Else
                    mQry = "Select * from BomDetail_Log where UID = '" & SearchCode & "' Order By Sr"
                End If
                ...
                With DsTemp.Tables(0)
                    ...
                    If .Rows.Count > 0 Then
                        For I = 0 To DsTemp.Tables(0).Rows.Count - 1
                            ...
                            Dgl1.AgSelectedValue(Col1BomItem, I) = AgL.XNull(.Rows(I)("Item"))
    ...
    Private Sub FrmYarn_BaseFunction_FIniMast(ByVal BytDel As Byte, ByVal BytRefresh As Byte) Handles Me.BaseFunction_FIniMast
        ...
        mQry = " Select I.Code As SearchCode " & _
            ...
            " And I.ItemType = '" & ClsMain.ItemType.FinishMaterial & "' Order By I.Description "
