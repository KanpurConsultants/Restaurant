...
#Region "Designer Code"
    Private Sub InitializeComponent()
        ...
        Me.TxtEMail.Location = New System.Drawing.Point(370, 231)
        ...
        Me.LblEMail.Location = New System.Drawing.Point(275, 231)
        ...
        Me.TxtMobile.Location = New System.Drawing.Point(370, 211)
        Me.TxtMobile.MaxLength = 35
        Me.TxtMobile.Name = "TxtMobile"
        Me.TxtMobile.Size = New System.Drawing.Size(292, 18)
        ...
        Me.LblMobile.Location = New System.Drawing.Point(275, 211)
        ...
        Me.LblCity.Location = New System.Drawing.Point(275, 191)
        ...
        Me.LblAddress.Location = New System.Drawing.Point(275, 131)
        ...
        Me.LblManualCode.Location = New System.Drawing.Point(275, 71)
        ...
        Me.LblName.Location = New System.Drawing.Point(275, 91)
        ...
        Me.LblAcGroup.Location = New System.Drawing.Point(275, 111)
...
#End Region
    ...
    Private Sub FrmShade_BaseFunction_FIniMastLog(ByVal BytDel As Byte, ByVal BytRefresh As Byte) Handles Me.BaseFunction_FIniMastLog
        mQry = "Select S.UID As SearchCode " & _
               " From SubGroup_Log S  " & _
    ...
    Private Sub FrmQuality1_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        If FrmType = ClsMain.EntryPointType.Main Then
            mQry = "Select S.SubCode, S.ManualCode, S.DispName, S.GroupCode, S.Add1, S.Add2, S.Add3, S.CityCode, S.Mobile, S.EMail, S.Nature, S.GroupNature " & _
                    " From SubGroup S  " & _
                    " Where S.SubCode='" & SearchCode & "'"
        Else
            mQry = "Select S.SubCode, S.ManualCode, S.DispName, S.GroupCode, S.Add1, S.Add2, S.Add3, S.CityCode, S.Mobile, S.EMail, S.Nature, S.GroupNature " & _
                    " From SubGroup_Log  S " & _
                    " Where S.UID='" & SearchCode & "'"
        End If
