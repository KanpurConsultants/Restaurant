...
#End Region
    ...
    Private Sub FrmYarn_BaseEvent_Data_Validation(ByRef passed As Boolean) Handles Me.BaseEvent_Data_Validation
        ...
        If Topctrl1.Mode = "Add" Then
            ...
            mQry = "Select count(*) From ItemGroup_Log Where Description='" & TxtDescription.Text & "' And " & AgTemplate.ClsMain.RetDivFilterStr & "  And EntryStatus='" & ClsMain.LogStatus.LogOpen & "' and IsNull(MoveToLog,'')=''  "
        ...
        Else
            ...
            mQry = "Select count(*) From ItemGroup_Log Where Description = '" & TxtDescription.Text & "' And UID <>'" & mSearchCode & "' And " & AgTemplate.ClsMain.RetDivFilterStr & "  And EntryStatus='" & ClsMain.LogStatus.LogOpen & "' and IsNull(MoveToLog,'')=''  "
            If AgL.Dman_Execute(mQry, AgL.GCn).ExecuteScalar > 0 Then Err.Raise(1, , "Description Already Exists in Log File")
        End If
    End Sub
    ...
    Public Overridable Sub FrmYarn_BaseEvent_FindLog() Handles Me.BaseEvent_FindLog
        ...
        AgL.PubFindQry = "SELECT I.UID, I.Description as Item_Group, C.Description as Item_Category  " & _
                        " FROM ItemGroup_Log I " & _
                        " Left Join ItemCategory C On I.ItemCategory = C.Code " & mConStr & _
                        " And I.EntryStatus = '" & ClsMain.LogStatus.LogOpen & "'  " & _
    ...
    Private Sub FrmYarn_BaseFunction_FIniMast(ByVal BytDel As Byte, ByVal BytRefresh As Byte) Handles Me.BaseFunction_FIniMast
        ...
        mQry = "Select I.Code As SearchCode " & _
            ...
            " And I.ItemType = '" & ClsMain.ItemType.FinishMaterial & "' And IsNull(I.IsDeleted,0)=0 Order By I.Description "
    ...
    Private Sub FrmYarn_BaseFunction_FIniMastLog(ByVal BytDel As Byte, ByVal BytRefresh As Byte) Handles Me.BaseFunction_FIniMastLog
        ...
        mQry = "Select I.UID As SearchCode " & _
               " From ItemGroup_log I " & mConStr & _
               " And I.ItemType = '" & ClsMain.ItemType.FinishMaterial & "'  And I.EntryStatus='" & LogStatus.LogOpen & "' Order By I.Description "
    ...
    Private Sub TxtItemCategory_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles TxtItemCategory.Enter
        mQry = " Select Code, Description " & _
               " From ItemCategory " & _
               " Where ItemType = '" & ClsMain.ItemType.FinishMaterial & "' " & _
               " Order By Description "
